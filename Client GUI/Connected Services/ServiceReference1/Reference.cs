...
namespace Client_GUI.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        Client_GUI.ServiceReference1.Contract[] GetCities();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetCities", ReplyAction="http://tempuri.org/IService1/GetCitiesResponse")]
        System.Threading.Tasks.Task<Client_GUI.ServiceReference1.Contract[]> GetCitiesAsync();
        ...
        Client_GUI.ServiceReference1.Station[] GetStationsByCity(string city);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetStationsByCity", ReplyAction="http://tempuri.org/IService1/GetStationsByCityResponse")]
        System.Threading.Tasks.Task<Client_GUI.ServiceReference1.Station[]> GetStationsByCityAsync(string city);
        ...
        Client_GUI.ServiceReference1.Station GetInfoByStation(string name, string city);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetInfoByStation", ReplyAction="http://tempuri.org/IService1/GetInfoByStationResponse")]
        System.Threading.Tasks.Task<Client_GUI.ServiceReference1.Station> GetInfoByStationAsync(string name, string city);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : Client_GUI.ServiceReference1.IService1, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<Client_GUI.ServiceReference1.IService1>, Client_GUI.ServiceReference1.IService1 {
        ...
        public Client_GUI.ServiceReference1.Contract[] GetCities() {
            return base.Channel.GetCities();
        }
        
        public System.Threading.Tasks.Task<Client_GUI.ServiceReference1.Contract[]> GetCitiesAsync() {
            return base.Channel.GetCitiesAsync();
        }
        
        public Client_GUI.ServiceReference1.Station[] GetStationsByCity(string city) {
            return base.Channel.GetStationsByCity(city);
        }
        
        public System.Threading.Tasks.Task<Client_GUI.ServiceReference1.Station[]> GetStationsByCityAsync(string city) {
            return base.Channel.GetStationsByCityAsync(city);
        }
        
        public Client_GUI.ServiceReference1.Station GetInfoByStation(string name, string city) {
            return base.Channel.GetInfoByStation(name, city);
        }
        
        public System.Threading.Tasks.Task<Client_GUI.ServiceReference1.Station> GetInfoByStationAsync(string name, string city) {
